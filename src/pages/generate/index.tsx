...
const MOCK_RESULTS: GeneratedRecipe[] = [
  { id: '1', name: '西红柿炒鸡蛋', tag: '推荐', tagType: 'success', time: '15分钟', calories: '280千卡', difficulty: '简单', ingredients: '鸡蛋3个、西红柿2个、葱花适量、盐少许、糖1小勺', steps: '鸡蛋打散炒至凝固盛出，西红柿切块炒出汁，加入鸡蛋翻炒均匀调味即可。', image: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=400&h=300&fit=crop' },
  { id: '2', name: '麻婆豆腐', tag: '微辣', tagType: 'accent', time: '25分钟', calories: '350千卡', difficulty: '中等', ingredients: '豆腐1块、猪肉末100g、豆瓣酱1勺、花椒粉适量', steps: '豆腐切块焯水，炒香肉末加豆瓣酱，放入豆腐加水焖煮，勾芡撒花椒粉出锅。', image: 'https://images.unsplash.com/photo-1582452919602-3ad3d9e4e4b7?w=400&h=300&fit=crop' },
  { id: '3', name: '家常豆腐煲', tag: '清淡', tagType: 'secondary', time: '30分钟', calories: '220千卡', difficulty: '简单', ingredients: '豆腐1块、西红柿1个、青菜3棵、蒜3瓣', steps: '砂锅热油爆香蒜片，放入西红柿炒软，加豆腐和调味料，小火焖煮10分钟。', image: 'https://images.unsplash.com/photo-1547592180-85f173990554?w=400&h=300&fit=crop' },
]
